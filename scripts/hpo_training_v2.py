#!/usr/bin/env python3
"""Run training-stage HPO with LoRA/PEFT support."""
...
from final_sc_review.hpo.objective_training_v2 import run_training_hpo_v2
...
def main() -> None:
    ...
    parser.add_argument("--config", type=str, default="configs/hpo_training_v2.yaml")
    parser.add_argument("--study_name", type=str, default="sc_training_v2")
    ...
    def _objective(trial):
        value = run_training_hpo_v2(trial, cfg)
